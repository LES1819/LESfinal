...
public class PapelhasAtividadeController implements Serializable {
    ...
    private void performDestroy() {
        try {
            ...
            String toSendView = "Papel " + current.getPapel().getNome() + " desassociado com sucesso.";
    ...
    public DataModel getAssociatedPapers(Atividade atividadeArg) {
        ...
        items = new ListDataModel(getFacade().getAssociatedPapers(atividade));
        return items;
    }

    public String destroyAsso(PapelhasAtividade papelHasAtividade, int saida) {
        current = papelHasAtividade;
        performDestroy();
        recreatePagination();
        recreateModel();
