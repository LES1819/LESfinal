...
public class AtividadehasPadraoController implements Serializable {
    ...
    private void performDestroy() {
        try {
            ...
            String toSendView = "Padrão " + current.getPadrao().getNome() + " desassociado com sucesso.";
    ...
    public DataModel getAssociatedPatterns(Atividade atividadeArg) {
        ...
        items = new ListDataModel(getFacade().getAssociatedPatterns(atividade));
        return items;
    }
    ...
    public String create() {
        try {
            current.getAtividadehasPadraoPK().setPadraoidPadrao(current.getPadrao().getIdPadrao());
    ...
    public String destroyAsso(AtividadehasPadrao atividadeHasPadrao,int saida) {
        current = atividadeHasPadrao;
        performDestroy();
        recreatePagination();
        recreateModel();
