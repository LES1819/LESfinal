...
public class ProdutohasAtividadeFacade extends AbstractFacade<ProdutohasAtividade> {
    ...
    public void destroyAsso(Atividade atividade) {
        em.createNamedQuery("ProdutohasAtividade.destroyAssociatedProducts").setParameter("atividade", atividade).executeUpdate();
    }
}
