...
public class AgrupamentoFacade extends AbstractFacade<Agrupamento> {
    ...
    public List removeByIdPadraoIdAgrup(int padr, int agrup){
        return em.createNamedQuery("AgrupamentohasPadrao.removeByIdPadraoIdAgrup").setParameter("idAgrup", agrup).setParameter("idPadrao", padr).getResultList();
    }
