...
@NamedQueries({
    ...
    @NamedQuery(name = "AtividadehasPadrao.findByPadraoidPadrao", query = "SELECT a FROM AtividadehasPadrao a WHERE a.atividadehasPadraoPK.padraoidPadrao = :padraoidPadrao"),
    @NamedQuery(name = "AtividadehasPadrao.associatedPatterns", query = "SELECT p FROM AtividadehasPadrao p WHERE p.atividade = :a"),
    @NamedQuery(name = "AtividadehasPadrao.destroyAssociatedPatterns", query = "DELETE FROM AtividadehasPadrao p WHERE p.atividade = :atividade"),
    @NamedQuery(name = "AtividadehasPadrao.removeByIdPadraoIdAtiv", query = "SELECT p FROM AtividadehasPadrao p WHERE (p.atividadehasPadraoPK.padraoidPadrao = :idPadrao AND p.atividadehasPadraoPK.atividadeidAtividades = :idAtiv)"),
...
public class AtividadehasPadrao implements Serializable {
    ...
    public AtividadehasPadrao(int atividadeidAtividades, int padraoidPadrao) {
        this.atividadehasPadraoPK = new AtividadehasPadraoPK(atividadeidAtividades, padraoidPadrao);
    }
